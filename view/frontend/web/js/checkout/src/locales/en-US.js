...
export default {
  ...
  payNoExpressWithBlockTitle: 'Checkout below with credit/debit card',
  ...
  welcomeMessages: {
    ...
    guestBody: "Continue as a guest with the option to create an account once you've placed your order.",
